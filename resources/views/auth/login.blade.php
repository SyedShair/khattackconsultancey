...
<div class="d-flex" style="min-height:100vh;">
    ...
    <div class="d-none d-lg-flex flex-column justify-content-between"
        ...
        <div style="position:relative; z-index:1;">
            ...
            <h1 style="font-size:34px; font-weight:700; line-height:1.25; margin-bottom:16px;">
    ...
    {{-- ============== Right form panel ============== --}}
    <div class="d-flex align-items-center justify-content-center" style="flex:1; padding:32px;">
        <div style="width:100%; max-width:400px;">

            <div class="d-lg-none text-center mb-4">
                @if($settings->logo ?? false)
                    <img src="{{ $settings->logo }}" alt="{{ $companyName }}" style="height:32px; border-radius:6px;">
                @else
                    <span style="font-size:20px; font-weight:700; color:#13201C;">{{ $companyName }}</span>
                @endif
            </div>

            <h2 style="font-size:26px; font-weight:700; color:#13201C; margin-bottom:6px;">Welcome back</h2>
            <p style="font-size:14px; color:#5F6C76; margin-bottom:28px;">Enter your credentials to continue</p>

            @if ($errors->any())
                <div class="alert" style="background:#fdecea; border:1px solid #f5c2c0; color:#8a1f16; border-radius:10px; font-size:13.5px; padding:12px 16px;">
                    <ul class="mb-0 ps-3">
            ...
            @if (session('status'))
                <div class="alert" style="background:#eaf7ef; border:1px solid #bfe6cc; color:#1e6b3c; border-radius:10px; font-size:13.5px; padding:12px 16px;">
                    {{ session('status') }}
                </div>
            @endif
